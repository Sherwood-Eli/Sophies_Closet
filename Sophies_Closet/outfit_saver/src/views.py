...
class Nav_View(ui.View):
	def __init__(self, outfit_saver):
		...
		self.all_views["outfit_category"] = Category_View()
		self.all_views["item_category"] = Category_View()
		self.all_views["outfit"] = Clothing_Unit_View("97C1B0", outfit_saver)
		self.all_views["item"] = Clothing_Unit_View("DCBCDA" , outfit_saver)
...
class Root_View(ui.View):
	def __init__(self, outfit_saver):
		...
		button_width = (self.width-(2*buffer))
		button_height = (self.height/2)-((3*buffer)+(buffer/2))
		...
		item_button_frame = (buffer, (self.height/2)+(buffer/2), button_width, button_height)
